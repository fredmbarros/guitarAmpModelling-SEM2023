...
Of course there are hardware digital amps that occupy sort of an intermediary position in this discussion, but here we will deal more with complete software solutions and compare them to full analogue tube amps. The decision to develop the argument on these bases stems from the fact that the users that interest us are usually working with these software amps at home, as their main reality, while aspiring to all-analogue tube amps.
